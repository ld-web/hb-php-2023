  ...
  <section class="container">
    ...
    <div class="row justify-content-center gap-3">
      ...
      foreach ($products as $product) { ?>
        <div class="d-flex flex-column gap-3 col-lg-3 mt-5 border rounded p-5">
          id : <?php echo $product['id']; ?><br />
          name : <?php echo $product['name']; ?><br />
          price : <?php echo $product['priceHT']; ?><br />
          promo : <?php echo $product['promo'] ? '✅' : '❌'; ?> <br />
          color : <div class=" col-md-6 col-3 text-light rounded" style="background-color: <?php echo $product['color']; ?>;">
